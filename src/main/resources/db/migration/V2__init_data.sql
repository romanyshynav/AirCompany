...
values ('ACTIVE', 1, 1, 'Argentina', 'India', 1000, 11111, '2000-01-01', '2000-01-01', '2021-03-17'),
       ...
       ('ACTIVE', 2, 2, 'Ukraine', 'Moldova', 1000, 11111, '2000-01-01', '2000-01-01', '2021-03-17'),
       ...
       ('ACTIVE', 3, 3, 'Turkie', 'China', 1000, 11111, '2000-01-01', '2000-01-01', '2021-03-17'),
       ('COMPLETED', 3, 3, 'Turkie', 'China', 1000, 11111, '2000-01-01', '2000-01-01', '2000-01-01'),

       ('ACTIVE', 4, 4, 'Ispania', '<24', 1000, 11111, '2000-01-01', '2000-01-01', '2021-03-17'),
       ('ACTIVE', 4, 4, 'Ispania', '<24', 1000, 11111, '2000-01-01', '2000-01-01', '2021-03-17'),
       ('ACTIVE', 4, 4, 'Ispania', '>24', 1000, 11111, '2000-01-01', '2000-01-01', '2021-03-10'),
       ('ACTIVE', 4, 4, 'Ispania', '>24', 1000, 11111, '2000-01-01', '2000-01-01', '2021-03-10'),
       ('COMPLETED', 4, 4, 'Ispania', 'Bad Status', 1000, 11111, '2000-01-01', '2000-01-01', '2021-03-10'),
       ('DELAYED', 4, 4, 'Ispania', 'Bad Status', 1000, 11111, '2000-01-01', '2000-01-01', '2021-03-10'),
       ('PENDING', 4, 4, 'Ispania', 'Bad Status', 1000, 11111, '2000-01-01', '2000-01-01', '2021-03-10')
;